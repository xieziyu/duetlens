...
const api: DuetlensApi = {
  ...
  review: {
    ...
    latestDiff: (reviewId) => ipcRenderer.invoke(IpcChannels.reviewLatestDiff, reviewId),
    fileContent: (reviewId, path) => ipcRenderer.invoke(IpcChannels.reviewFileContent, reviewId, path),
